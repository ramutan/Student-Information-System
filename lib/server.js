...
/* ---------- database ---------- */
const db = new Database(path.join(__dirname, 'sis.db'));
...
app.use(session({ secret: 'change-this-secret-string', resave: false, saveUninitialized: false, cookie: { maxAge: 1000 * 60 * 60 * 8 } }));
